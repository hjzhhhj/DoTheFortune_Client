...
export default function CompatibilityResult() {
  // TODO: 실제 데이터 연동 시 props 또는 상태로 교체
  const user1Name = "희진님";
  const user2Name = "성연님";
  const user1Info = "성별 : 여자\n생년월일 : 2009.01.20";
  const user2Info = "성별 : 여자\n생년월일 : 2008.01.21";

  // Figma에 있는 각 회색 섹션 텍스트를 개별 블록으로 분리
  ...
  return (
    <div className="compat-result-root" style={{ overflowX: "hidden" }}>
      {/* 전체 요소 60% 축소 */}
      <div
        className="compat-scale"
        style={{
          transform: "scale(0.6)",
      ...
      >
        ...
        <div className="compat-content">
          <Header logoSrc={Logo} title="빌려온 사주" showSettings={false} />
